                            ...
                            <div className="flex flex-wrap gap-2">
                                {radiusOptions.map((option) => (
                                    <button
                                        ...
                                        className={`px-3 py-2 rounded-lg text-sm transition-all ${radius === option.value
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <button
                                        ...
                                        className={`w-full p-3 rounded-xl flex items-center gap-3 transition-all ${isLocationSelected({ lat: centerLat, lng: centerLng })
                                    ...
                                    {zone.suggestedLocations.map((loc, index) => (
                                        <button
                                            ...
                                            className={`w-full p-3 rounded-xl flex items-center gap-3 transition-all ${isLocationSelected(loc)
                                                    ? 'bg-purple-500/20 border-2 border-purple-500'
                                                    : 'bg-slate-700/50 hover:bg-slate-700'
                                                }`}
                                        >
