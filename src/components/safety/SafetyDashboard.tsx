                                    ...
                                    <div key={severity} className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <div className="h-2 bg-slate-700 rounded-full overflow-hidden">
                                                <motion.div
                                                    className={`h-full rounded-full ${severity === 'critical'
                                                            ? 'bg-red-500'
                                                            : severity === 'high'
                                                                ? 'bg-orange-500'
                                                                : severity === 'medium'
                            ...
                            >
                                <div className="flex items-start justify-between mb-2">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span
                                            className={`text-lg font-bold ${area.score >= 85
                                                    ? 'text-emerald-400'
                                                    : area.score >= 70
                                                        ? 'text-yellow-400'
                                                        : 'text-red-400'
    ...
    return (
        ...
        >
            ...
            <div className="flex items-end justify-between">
                ...
                {trend !== undefined && (
                    <div
                        className={`flex items-center text-sm ${trend < 0 ? 'text-emerald-400' : trend > 0 ? 'text-red-400' : 'text-slate-400'
                            }`}
                    >
                        {trend < 0 ? (
                ...
                >
                    <div className="w-full flex flex-col gap-0.5 h-36">
                        ...
                        <motion.div
                            ...
                            initial={{ height: 0 }}
                            animate={{
                                height: `${((day.incidents - day.sosAlerts - day.reports) / maxIncidents) * 100
                                    }%`,
                            }}
                            transition={{ duration: 0.3, delay: index * 0.02 }}
                        />
