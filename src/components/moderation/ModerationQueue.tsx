            ...
            >
                ...
                <div className="p-4 space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className={`px-3 py-1 text-sm rounded-lg capitalize ${report.severity === 'critical' ? 'bg-red-500/20 text-red-400' :
                        ...
                        <div className="pt-4 border-t border-slate-700 space-y-3">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-lg flex items-center justify-center gap-2 transition-colors ${action === 'take_action'
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-lg flex items-center justify-center gap-2 transition-colors ${action === 'dismiss'
