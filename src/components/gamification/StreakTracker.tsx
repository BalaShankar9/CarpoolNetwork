                        ...
                        {weekActivity.map((active, i) => (
                            <div key={i} className="flex-1 text-center">
                                <motion.div
                                    ...
                                    className={`aspect-square rounded-lg flex items-center justify-center ${active ? 'bg-white text-orange-500' : 'bg-white/20'
                                        }`}
                                >
                                    {active ? (
                ...
                <div className="flex flex-wrap gap-2">
                    {STREAK_MILESTONES.map((milestone) => {
                        ...
                        return (
                            <div
                                key={milestone}
                                className={`px-3 py-2 rounded-lg text-sm font-medium ${isAchieved
