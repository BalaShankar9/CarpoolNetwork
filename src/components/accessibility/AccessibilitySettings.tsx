      ...
      <div className="p-4 space-y-6">
        ...
        <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-xl">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full transition-colors ${
              settings.highContrast ? 'bg-blue-500' : 'bg-slate-600'
            }`}
          >
            <motion.div
        ...
        <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-xl">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full transition-colors ${
              settings.reducedMotion ? 'bg-blue-500' : 'bg-slate-600'
            }`}
          >
            <motion.div
        ...
        <div className="flex items-center justify-between p-4 bg-slate-700/50 rounded-xl">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full transition-colors ${
              settings.screenReaderOptimized ? 'bg-blue-500' : 'bg-slate-600'
            }`}
          >
            <motion.div
            ...
            {colorBlindOptions.map((option) => (
              ...
              >
                <span className={`text-sm ${
                  settings.colorBlindMode === option.value ? 'text-blue-300' : 'text-slate-300'
                }`}>
                  {option.label}
                </span>
                {settings.colorBlindMode === option.value && (
