...
export function NotificationCenter({ isOpen = true, onClose, embedded = false }: NotificationCenterProps) {
    ...
    const content = (
        <div
            ref={containerRef}
            className={`flex flex-col ${embedded ? 'h-full' : 'max-h-[80vh]'
            ...
            <div className="flex gap-1 p-2 border-b border-gray-100 dark:border-gray-700 overflow-x-auto">
                {CATEGORIES.map((cat) => (
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${filter === cat.id
...
function NotificationItem({
    ...
    return (
        <motion.div
            ...
            className={`relative group border-b border-gray-100 dark:border-gray-700 ${notification.read ? 'bg-white dark:bg-gray-800' : 'bg-emerald-50/50 dark:bg-emerald-900/10'
                }`}
        >
            <button
                onClick={handleClick}
                ...
                <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                            <p
                                className={`font-medium line-clamp-1 ${notification.read
                    ...
                    <div className="space-y-2">
                        {[
                            ...
                            >
                                ...
                                <div
                                    className={`w-10 h-6 rounded-full transition-colors ${settings[item.key as keyof typeof settings]
                                            ? 'bg-emerald-500'
                                            : 'bg-gray-300 dark:bg-gray-600'
                                        }`}
                                >
                                    <div
                                        className={`w-5 h-5 bg-white rounded-full shadow transition-transform mt-0.5 ${settings[item.key as keyof typeof settings]
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            <div
                                className={`w-10 h-6 rounded-full transition-colors ${settings.sounds ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-gray-600'
                                    }`}
                            >
                                <div
                                    className={`w-5 h-5 bg-white rounded-full shadow transition-transform mt-0.5 ${settings.sounds ? 'translate-x-5 ml-0.5' : 'translate-x-0.5'
                                        }`}
                                />
                            </div>
                        </button>
                        ...
                        >
                            ...
                            <div
                                className={`w-10 h-6 rounded-full transition-colors ${settings.push ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-gray-600'
                                    }`}
                            >
                                <div
                                    className={`w-5 h-5 bg-white rounded-full shadow transition-transform mt-0.5 ${settings.push ? 'translate-x-5 ml-0.5' : 'translate-x-0.5'
                                        }`}
                                />
                            </div>
                        </button>
                        ...
                        >
                            ...
                            <div
                                className={`w-10 h-6 rounded-full transition-colors ${settings.email ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-gray-600'
                                    }`}
                            >
                                <div
                                    className={`w-5 h-5 bg-white rounded-full shadow transition-transform mt-0.5 ${settings.email ? 'translate-x-5 ml-0.5' : 'translate-x-0.5'
                                        }`}
                                />
                            </div>
                        </button>
