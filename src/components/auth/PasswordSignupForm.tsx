      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            disabled={disabled || loading}
            className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent disabled:bg-gray-50 disabled:cursor-not-allowed ${emailValid === false ? 'border-red-300 bg-red-50' : emailValid === true ? 'border-green-300 bg-green-50' : 'border-gray-300'
              }`}
          />
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            required
            disabled={disabled || loading}
            className={`w-full pl-10 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent disabled:bg-gray-50 disabled:cursor-not-allowed ${confirmEmail && !emailsMatch ? 'border-red-300 bg-red-50' : confirmEmail && emailsMatch ? 'border-green-300 bg-green-50' : 'border-gray-300'
              }`}
          />
          <div className="absolute right-3 top-1/2 -translate-y-1/2">
        ...
        <div className="flex gap-2">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              disabled={disabled || loading}
              className={`flex items-center gap-1 px-3 py-3 border rounded-xl bg-white hover:bg-gray-50 transition-colors min-w-[100px] ${disabled || loading ? 'opacity-50 cursor-not-allowed' : ''
                ...
                <div className="overflow-y-auto max-h-48">
                  {filteredCountries.map((country) => (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-3 py-2 hover:bg-gray-50 transition-colors ${selectedCountry.code === country.code ? 'bg-red-50' : ''
                        }`}
                    >
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              required
              disabled={disabled || loading}
              className={`w-full pl-10 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent disabled:bg-gray-50 disabled:cursor-not-allowed ${phoneNumber && !isValidPhoneNumber() ? 'border-red-300' : 'border-gray-300'
                }`}
            />
          </div>
        </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <span className="text-sm text-gray-700">
            I agree to the{' '}
            <Link to="/terms" className="text-red-600 hover:text-red-700 font-semibold underline" target="_blank">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link to="/privacy" className="text-red-600 hover:text-red-700 font-semibold underline" target="_blank">
              Privacy Policy
            </Link>
            . I understand that my information will be used as described in the privacy policy.
          </span>
        </label>
      </div>
