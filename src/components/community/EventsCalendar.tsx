            ...
            <div className="grid grid-cols-7">
                {days.map((day, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`min-h-[100px] p-1 border-b border-r border-gray-100 dark:border-gray-700 ${day ? 'hover:bg-gray-50 dark:hover:bg-gray-700/50' : 'bg-gray-50 dark:bg-gray-800/50'
                                }`}
                        >
                            {day && (
                                <>
                                    <span
                                        className={`inline-flex items-center justify-center w-7 h-7 text-sm ${isToday
