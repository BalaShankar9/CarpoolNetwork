        ...
        <div className="relative flex items-center gap-1">
            ...
            {quickActions.map((action) => (
                <motion.button
                    ...
                    className={`p-1.5 rounded-lg transition-colors ${action.destructive
                        ...
                        >
                            {moreActions.map((action) => (
                                <button
                                    key={action.id}
                                    onClick={action.onClick}
                                    className={`w-full px-3 py-2 flex items-center gap-3 text-sm transition-colors ${action.destructive
