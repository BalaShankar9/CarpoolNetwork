...
import { ArrowLeft, MessageSquare, User, Calendar, ExternalLink, Trash2, LayoutDashboard } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">Bug reports and suggestions from users</p>
          </div>
        </div>
