  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start sm:items-center justify-between gap-4 py-3 border-b border-gray-100">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-1">Allow passengers to book instantly without approval</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                <input
                  type="checkbox"
            ...
            <div className="py-3 border-b border-gray-100">
              <label className="block font-medium text-gray-900 mb-3">Smoking policy</label>
              <select
            ...
            <div className="py-3 border-b border-gray-100">
              <div className="flex items-center gap-2 mb-3">
                <label className="block font-medium text-gray-900">Pets allowed</label>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                <span className="ml-3 text-sm text-gray-600">Allow pets in your vehicle</span>
              </label>
            </div>

            <div className="py-3 border-b border-gray-100">
              <label className="block font-medium text-gray-900 mb-3">Music preference</label>
              <select
            ...
            <div className="py-3">
              <label className="block font-medium text-gray-900 mb-3">Conversation level</label>
              <select
      ...
      {vehicleToRemovePhoto && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Remove Vehicle Photo?</h3>
            <p className="text-gray-600 mb-6">
              Are you sure you want to remove this vehicle photo?
            </p>
      ...
      {vehicleToDelete && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Delete Vehicle?</h3>
            <p className="text-gray-600 mb-6">
